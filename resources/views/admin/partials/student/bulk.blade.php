...
<div class="tab-content mt-5">
    <div class="tab-pane active">
        <form method="POST" class="col-md-12 ajaxForm" action="{{route('student.bulkStore')}}" id="bulk_submit" autocomplete="off">
            @csrf
            ...
            <div id="first-row">
                <div class="row">
                    <div class="col-12">
                        <div class="row justify-content-md-center">
                            <div
                                class="form-group col-xl-2 col-lg-2 col-md-12 col-sm-12 mb-1 mb-lg-0">
            ...
            <div class="text-center mt-3">
                <button type="submit"
                    class="btn btn-outline-info col-md-4 col-sm-12 mb-4 mt-2">
...
$("#bulk_submit").on('submit',(e)=>{
    e.preventDefault();
    const data = $("#bulk_submit").serialize();
    const url = $("#bulk_submit").attr('action');
    const method = $("#bulk_submit").attr('method');
    $.ajax({
        url:url,
        method:method,
        data:data,
        success: res=>{
            ...
            if(res.status == 200){
                $("form").trigger("reset");
                toast('success','Students Create Successful!');
            }else{
                toast('error',res.error);
            }
        },
