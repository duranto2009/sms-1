                ...
                <nav class="navbar fixed-top">
                    ...
                    <div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                            ...
                            <!-- End Notifications -->
                            <!-- User -->
                            <li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img src="{{asset('admin/img/avatar/avatar-01.jpg')}}" alt="..." class="avatar rounded-circle"></a>
                                        ...
                                        <div class="post-container">
                                            <div class="media mb-3">
                                                <div class="media-left align-self-center user">
                                                    <a href="pages-profile.html"><img src="{{asset('admin/img/avatar/avatar-07.jpg')}}" class="rounded-circle" alt="..."></a>
                                                </div>
                                ...
                                <div class="widget widget-05 has-shadow">
                                    ...
                                    <div class="widget-body no-padding hidden">
                                        <div class="author-avatar">
                                            ...
                                            <img src="{{asset('admin/img/avatar/avatar-03.jpg')}}" alt="..." class="img-fluid rounded-circle">
                                        </div>
                                        ...
                                        <div id="list-group" class="widget-scroll" style="max-height:490px;">
                                            <ul class="reviews list-group w-100">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left align-self-start">
                                                            <img src="{{asset('admin/img/avatar/avatar-02.jpg')}}" class="user-img rounded-circle" alt="...">
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                            <div class="username">
                                                                <h4>Brandon Smith</h4>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left align-self-start">
                                                            <img src="{{asset('admin/img/avatar/avatar-05.jpg')}}" class="user-img rounded-circle" alt="...">
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                            <div class="username">
                                                                <h4>Megan Duncan</h4>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left align-self-start">
                                                            <img src="{{asset('admin/img/avatar/avatar-04.jpg')}}" class="user-img rounded-circle" alt="...">
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                            <div class="username">
                                                                <h4>Nathan Hunter</h4>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left align-self-start">
                                                            <img src="{{asset('admin/img/avatar/avatar-09.jpg')}}" class="user-img rounded-circle" alt="...">
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                            <div class="username">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left align-self-start">
                                                            <img src="{{asset('admin/img/avatar/avatar-03.jpg"')}} class="user-img rounded-circle" alt="...">
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                            <div class="username">
                                                                <h4>Louis Henry</h4>
                                            ...
                                            <div class="d-flex flex-column mr-auto">
                                                <div class="title">
                                                    ...
                                                    <div class="users-like">
                                                        <a href="profile.html">
                                                            <img src="{{asset('admin/img/avatar/avatar-01.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                        <a href="profile.html">
                                                            <img src="{{asset('admin/img/avatar/avatar-02.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                        <a href="profile.html">
                                                            <img src="{{asset('admin/img/avatar/avatar-07.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                        <a href="profile.html">
                                                            <img src="{{asset('admin/img/avatar/avatar-09.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex flex-column mr-auto">
                                                <div class="title">
                                                    ...
                                                    <div class="users-like">
                                                        ...
                                                        <a href="profile.html">
                                                            <img src="{{asset('admin/img/avatar/avatar-06.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                        <a href="profile.html">
                                                            <img src="{{asset('admin/img/avatar/avatar-03.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="new-message">
                                            <div class="media">
                                                <div class="media-left align-self-center mr-3">
                                                    <img src="{{asset('admin/img/avatar/avatar-04.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                                </div>
                                                <div class="media-body align-self-center">
                                        ...
                                        <ul class="list-group w-100 mt-5">
                                            <li class="list-group-item">
                                                <div class="other-message">
                                                    <div class="media">
                                                        <div class="media-left align-self-center mr-3">
                                                            <img src="{{asset('admin/img/avatar/avatar-02.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                                        </div>
                                                        <div class="media-body align-self-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="other-message">
                                                    <div class="media">
                                                        <div class="media-left align-self-center mr-3">
                                                            <img src="{{asset('admin/img/avatar/avatar-03.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                                        </div>
                                                        <div class="media-body align-self-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="other-message">
                                                    <div class="media">
                                                        <div class="media-left align-self-center mr-3">
                                                            <img src="{{asset('admin/img/avatar/avatar-05.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                                        </div>
                                                        <div class="media-body align-self-center">
                                    ...
                                    <div class="widget-body p-0">
                                        ...
                                        <ul class="list-group w-100 widget-scroll" style="max-height:250px;">
                                            <li class="list-group-item">
                                                <div class="media">
                                                    <div class="media-left align-self-center mr-3">
                                                        <img src="{{asset('admin/img/avatar/avatar-02.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                                    </div>
                                                    <div class="media-body align-self-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media">
                                                    <div class="media-left align-self-center mr-3">
                                                        <img src="{{asset('admin/img/avatar/avatar-03.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                                    </div>
                                                    <div class="media-body align-self-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media">
                                                    <div class="media-left align-self-center mr-3">
                                                        <img src="{{asset('admin/img/avatar/avatar-04.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                                    </div>
                                                    <div class="media-body align-self-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media">
                                                    <div class="media-left align-self-center mr-3">
                                                        <img src="{{asset('admin/img/avatar/avatar-05.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                                    </div>
                                                    <div class="media-body align-self-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media">
                                                    <div class="media-left align-self-center mr-3">
                                                        <img src="{{asset('admin/img/avatar/avatar-06.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                                    </div>
                                                    <div class="media-body align-self-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media">
                                                    <div class="media-left align-self-center mr-3">
                                                        <img src="{{asset('admin/img/avatar/avatar-07.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                                    </div>
                                                    <div class="media-body align-self-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media">
                                                    <div class="media-left align-self-center mr-3">
                                                        <img src="{{asset('admin/img/avatar/avatar-08.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                                    </div>
                                                    <div class="media-body align-self-center">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media">
                                                    <div class="media-left align-self-center mr-3">
                                                        <img src="{{asset('admin/img/avatar/avatar-09.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                                    </div>
                                                    <div class="media-body align-self-center">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane show active fade" id="messenger" aria-labelledby="messenger-tab">
                                        ...
                                        <div class="messenger-message messenger-message-sender">
                                            <img class="messenger-image messenger-image-default" src="{{asset('admin/img/avatar/avatar-02.jpg')}}" alt="...">
                                        ...
                                        <div class="messenger-message messenger-message-sender">
                                            <img class="messenger-image messenger-image-default" src="{{asset('admin/img/avatar/avatar-05.jpg')}}" alt="...">
                                            <div class="messenger-message-wrapper">
                                                <div class="messenger-message-content">
                                                    <p>
